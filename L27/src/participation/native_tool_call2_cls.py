...
@tool("get_city_temperature", description="Returns the current temperature in Fahrenheit for a US city")
...
if __name__ == "__main__":
    ...
    tools = [get_city_temperature] #PLACEHOLDER# modify this line
